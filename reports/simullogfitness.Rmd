...
plot(Ntube, powerboot, xlab="Number of tubes", ylab="Power", ylim=c(0, 1), las=1, type="l", xaxt='n')
lines(Ntube, powernormapprox, col="red")
axis(1, at=seq(0, 100, by=10))
abline(h=0.95, col="red", lty=2)
legend(0, 0.5, legend=c("Boostrapping", "Normal approximation"), col=1:2, bty="n", lwd=1)
## 95% CI should be computed with c(0.025*delta, 0.975+0.025*(1-delta))
